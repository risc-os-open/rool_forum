...
module Thredded
  module PostCommon
    ...
    def filtered_content(view_context, users_provider: ->(names) { readers_from_user_names(names) })
      formatter = Thredded::ContentFormatter.new(view_context, users_provider: users_provider)
      formatter.markup_filters = [
        Thredded::HtmlPipeline::TextileFilter # In this app's models/thredded/html_pipeline folder
      ]
